...
- the algorithm
  ...
  - If $e<e_1$, insert $e$ along with its right child link to $u$; otherwise insert $e$ along with its right child link to $v$, as shown in (b),(c),(d) for the cases $e_0 < e < e_1, e_1 <e<e_2, e_2<e$ respectively
